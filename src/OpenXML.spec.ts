...
describe('OpenXML', () => {
    ...
    describe('parser', () => {
        ...
        describe('{=}', () => {
            ...
            it('partial simple', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="001D070B" w:rsidRDefault="009A3E0C"><w:r><w:t xml:space="preserve">{</w:t></w:r><w:r w:rsidR="00EB4B5F"><w:t xml:space="preserve">=</w:t></w:r><w:r><w:t xml:space="preserve">text</w:t></w:r><w:r><w:t xml:space="preserve">}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
            ...
            it('partial with styles', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="004A714F" w:rsidRPr="00EE4ABE" w:rsidRDefault="004A714F" w:rsidP="00321585"><w:pPr><w:rPr><w:rFonts w:cstheme="minorHAnsi"/></w:rPr></w:pPr><w:r w:rsidRPr="009A7D0E"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:b/><w:bCs/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t>Account</w:t></w:r><w:r w:rsidRPr="009A7D0E"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:b/><w:bCs/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t xml:space="preserve"> Manager :</w:t></w:r><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t xml:space="preserve"> {=</w:t></w:r><w:proofErr w:type="gramStart"/><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t>commercial.initiales</w:t></w:r><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t>}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
                const xml = node.render({ data: { commercial: { initiales: 'AI' } } })
                expect(xml).toEqual('<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="004A714F" w:rsidRPr="00EE4ABE" w:rsidRDefault="004A714F" w:rsidP="00321585"><w:pPr><w:rPr><w:rFonts w:cstheme="minorHAnsi"/></w:rPr></w:pPr><w:r w:rsidRPr="009A7D0E"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:b/><w:bCs/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t>Account Manager :</w:t></w:r><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:cstheme="minorHAnsi"/><w:color w:val="808080" w:themeColor="background1" w:themeShade="80"/></w:rPr><w:t xml:space="preserve"> AI</w:t></w:r></w:p></body>')
            })
        })
        describe('LINK {L=}', () => {
            it('one', async () => {
        ...
        describe('FOR {D=}', () => {
            ...
            it('partial', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="001D070B" w:rsidRDefault="009A3E0C"><w:r><w:t xml:space="preserve">A date: {D</w:t></w:r><w:r w:rsidR="00EB4B5F"><w:t xml:space="preserve">=</w:t></w:r><w:r><w:t xml:space="preserve">(text,</w:t></w:r><w:r><w:t xml:space="preserve">MM-DD-YYYY)}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
        ...
        describe('FOR {F=}', () => {
            ...
            it('should replace in a table', async () => {
                ...
                expect(xml).toEqual(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:cx="http://schemas.microsoft.com/office/drawing/2014/chartex" xmlns:cx1="http://schemas.microsoft.com/office/drawing/2015/9/8/chartex" xmlns:cx2="http://schemas.microsoft.com/office/drawing/2015/10/21/chartex" xmlns:cx3="http://schemas.microsoft.com/office/drawing/2016/5/9/chartex" xmlns:cx4="http://schemas.microsoft.com/office/drawing/2016/5/10/chartex" xmlns:cx5="http://schemas.microsoft.com/office/drawing/2016/5/11/chartex" xmlns:cx6="http://schemas.microsoft.com/office/drawing/2016/5/12/chartex" xmlns:cx7="http://schemas.microsoft.com/office/drawing/2016/5/13/chartex" xmlns:cx8="http://schemas.microsoft.com/office/drawing/2016/5/14/chartex" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:aink="http://schemas.microsoft.com/office/drawing/2016/ink" xmlns:am3d="http://schemas.microsoft.com/office/drawing/2017/model3d" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:wp14="http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:w15="http://schemas.microsoft.com/office/word/2012/wordml" xmlns:w16cid="http://schemas.microsoft.com/office/word/2016/wordml/cid" xmlns:w16se="http://schemas.microsoft.com/office/word/2015/wordml/symex" xmlns:wpg="http://schemas.microsoft.com/office/word/2010/wordprocessingGroup" xmlns:wpi="http://schemas.microsoft.com/office/word/2010/wordprocessingInk" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wps="http://schemas.microsoft.com/office/word/2010/wordprocessingShape" mc:Ignorable="w14 w15 w16se w16cid wp14"><w:body><w:tbl><w:tblPr><w:tblStyle w:val="Grilledutableau"/><w:tblW w:w="0" w:type="auto"/><w:tblLook w:val="04A0" w:firstRow="1" w:lastRow="0" w:firstColumn="1" w:lastColumn="0" w:noHBand="0" w:noVBand="1"/></w:tblPr><w:tblGrid><w:gridCol w:w="4531"/><w:gridCol w:w="4531"/></w:tblGrid><w:tr w:rsidR="001D070B" w:rsidTr="001D070B"><w:tc><w:tcPr><w:tcW w:w="4531" w:type="dxa"/></w:tcPr><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"><w:r><w:t xml:space="preserve">Un tableau de tableau</w:t></w:r></w:p><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"/><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B" w:rsidP="00A435CE"><w:r><w:t xml:space="preserve">Un lien</w:t></w:r></w:p><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"/><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"><w:r><w:t xml:space="preserve">Un lien dans une boucle:</w:t></w:r></w:p><w:p w:rsidR="00BE2791" w:rsidRPr="00BE2791" w:rsidRDefault="00BE2791"><w:pPr><w:rPr><w:b/><w:bCs/></w:rPr></w:pPr><w:r w:rsidRPr="00BE2791"><w:rPr><w:b/><w:bCs/></w:rPr><w:t xml:space="preserve">Test.txt</w:t></w:r></w:p><w:p w:rsidR="00BE2791" w:rsidRPr="00BE2791" w:rsidRDefault="00BE2791"><w:pPr><w:rPr><w:b/><w:bCs/></w:rPr></w:pPr><w:r w:rsidRPr="00BE2791"><w:rPr><w:b/><w:bCs/></w:rPr><w:t xml:space="preserve">Test2.txt</w:t></w:r></w:p></w:tc><w:tc><w:tcPr><w:tcW w:w="4531" w:type="dxa"/></w:tcPr><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"><w:r><w:t xml:space="preserve">Un autre texte</w:t></w:r></w:p></w:tc></w:tr></w:tbl><w:p w:rsidR="00E95C5A" w:rsidRDefault="00E95C5A"/><w:sectPr w:rsidR="00E95C5A"><w:headerReference w:type="even" r:id="rId6"/><w:headerReference w:type="default" r:id="rId7"/><w:footerReference w:type="even" r:id="rId8"/><w:footerReference w:type="default" r:id="rId9"/><w:headerReference w:type="first" r:id="rId10"/><w:footerReference w:type="first" r:id="rId11"/><w:pgSz w:w="11906" w:h="16838"/><w:pgMar w:top="1417" w:right="1417" w:bottom="1417" w:left="1417" w:header="708" w:footer="708" w:gutter="0"/><w:cols w:space="708"/><w:docGrid w:linePitch="360"/></w:sectPr></w:body></w:document>`)
            })
            ...
            it('should replace with multiples block in the loop and last block in place', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:cx="http://schemas.microsoft.com/office/drawing/2014/chartex" xmlns:cx1="http://schemas.microsoft.com/office/drawing/2015/9/8/chartex" xmlns:cx2="http://schemas.microsoft.com/office/drawing/2015/10/21/chartex" xmlns:cx3="http://schemas.microsoft.com/office/drawing/2016/5/9/chartex" xmlns:cx4="http://schemas.microsoft.com/office/drawing/2016/5/10/chartex" xmlns:cx5="http://schemas.microsoft.com/office/drawing/2016/5/11/chartex" xmlns:cx6="http://schemas.microsoft.com/office/drawing/2016/5/12/chartex" xmlns:cx7="http://schemas.microsoft.com/office/drawing/2016/5/13/chartex" xmlns:cx8="http://schemas.microsoft.com/office/drawing/2016/5/14/chartex" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:aink="http://schemas.microsoft.com/office/drawing/2016/ink" xmlns:am3d="http://schemas.microsoft.com/office/drawing/2017/model3d" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:wp14="http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:w15="http://schemas.microsoft.com/office/word/2012/wordml" xmlns:w16cid="http://schemas.microsoft.com/office/word/2016/wordml/cid" xmlns:w16se="http://schemas.microsoft.com/office/word/2015/wordml/symex" xmlns:wpg="http://schemas.microsoft.com/office/word/2010/wordprocessingGroup" xmlns:wpi="http://schemas.microsoft.com/office/word/2010/wordprocessingInk" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wps="http://schemas.microsoft.com/office/word/2010/wordprocessingShape" mc:Ignorable="w14 w15 w16se w16cid wp14"><w:body><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"><w:r><w:t xml:space="preserve">{F=doc IN documents}</w:t></w:r></w:p><w:p w:rsidR="001D070B" w:rsidRDefault="009A3E0C"><w:r><w:t xml:space="preserve">{=doc.text}</w:t></w:r></w:p><w:p w:rsidR="001D070B" w:rsidRDefault="001D070B"><w:r><w:t xml:space="preserve">{/F}</w:t></w:r></w:p><w:p w:rsidR="00E95C5A" w:rsidRDefault="00E95C5A"/><w:sectPr w:rsidR="00E95C5A"><w:headerReference w:type="even" r:id="rId6"/><w:headerReference w:type="default" r:id="rId7"/><w:footerReference w:type="even" r:id="rId8"/><w:footerReference w:type="default" r:id="rId9"/><w:headerReference w:type="first" r:id="rId10"/><w:footerReference w:type="first" r:id="rId11"/><w:pgSz w:w="11906" w:h="16838"/><w:pgMar w:top="1417" w:right="1417" w:bottom="1417" w:left="1417" w:header="708" w:footer="708" w:gutter="0"/><w:cols w:space="708"/><w:docGrid w:linePitch="360"/></w:sectPr></w:body></w:document>`
                const node = await OpenXML.parse(template)
    ...
    describe('Number {N=}', () => {
        ...
        it('partial', async () => {
            const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="001D070B" w:rsidRDefault="009A3E0C"><w:r><w:t xml:space="preserve">A number: {N</w:t></w:r><w:r w:rsidR="00EB4B5F"><w:t xml:space="preserve">=</w:t></w:r><w:r><w:t xml:space="preserve">(text,</w:t></w:r><w:r><w:t xml:space="preserve">1,$)}</w:t></w:r></w:p></body>`
            const node = await OpenXML.parse(template)
