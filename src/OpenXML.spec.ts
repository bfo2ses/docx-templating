...
describe('OpenXML', () => {
    ...
    describe('parser', () => {
        ...
        describe('IF {IF=()}', () => {
            ...
            it('inline =', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p><w:r><w:t xml:space="preserve">{IF=(document.text == 'Microsoft')}This is Microsoft{/IF}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
                const xml = node.render({ data: { document: { text: 'Microsoft' } } })
                expect(xml).toEqual(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p><w:r><w:t xml:space="preserve">This is Microsoft</w:t></w:r></w:p></body>`)
            })
            it('inline !=', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p><w:r><w:t xml:space="preserve">{IF=(document.text != 'Microsoft')}This is not Microsoft{/IF}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
                const xml = node.render({ data: { document: { text: 'Google' } } })
                expect(xml).toEqual(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p><w:r><w:t xml:space="preserve">This is not Microsoft</w:t></w:r></w:p></body>`)
            })
            it('inline &&', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p><w:r><w:t xml:space="preserve">{IF=(document.text != 'Microsoft' &amp;&amp; document.text != 'Google')}This is not Microsoft nor Google{/IF}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
                const xml = node.render({ data: { document: { text: 'Facebook' } } })
                expect(xml).toEqual(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p><w:r><w:t xml:space="preserve">This is not Microsoft nor Google</w:t></w:r></w:p></body>`)
            })
            it('inline multiple', async () => {
                const template = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="00B2223B" w:rsidRPr="00EE4ABE" w:rsidRDefault="00B2223B" w:rsidP="00B2223B"><w:pPr><w:pStyle w:val="Corpsdetexte"/><w:spacing w:after="120" w:line="262" w:lineRule="exact"/><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr></w:pPr><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>Description: {</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>IF</w:t></w:r><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>=</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>(</w:t></w:r><w:proofErr w:type="spellStart"/><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>opportunite.offre</w:t></w:r><w:proofErr w:type="spellEnd"/><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t xml:space="preserve"> == </w:t></w:r><w:r w:rsidR="00E64803" w:rsidRPr="00E64803"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>'</w:t></w:r><w:bookmarkStart w:id="13" w:name="_GoBack"/><w:bookmarkEnd w:id="13"/><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>barriques</w:t></w:r><w:r w:rsidR="00E64803" w:rsidRPr="00E64803"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>'</w:t></w:r><w:r w:rsidR="00010CA3"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>)</w:t></w:r><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>}</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>Barrels{/IF}</w:t></w:r><w:r w:rsidR="000E5C76" w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>{</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>IF</w:t></w:r><w:r w:rsidR="000E5C76" w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>=</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>(</w:t></w:r><w:proofErr w:type="spellStart"/><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>opportunite.offre</w:t></w:r><w:proofErr w:type="spellEnd"/><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t xml:space="preserve"> == </w:t></w:r><w:r w:rsidR="00E64803" w:rsidRPr="00E64803"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>'</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>diversification</w:t></w:r><w:r w:rsidR="00E64803" w:rsidRPr="00E64803"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>'</w:t></w:r><w:r w:rsidR="00010CA3"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>)</w:t></w:r><w:r w:rsidR="000E5C76" w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>}</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>Divers</w:t></w:r><w:r w:rsidR="000E5C76"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t>{/IF}</w:t></w:r></w:p></body>`
                const node = await OpenXML.parse(template)
                const xml = node.render({ data: { opportunite: { offre: 'barriques' } } })
                expect(xml).toEqual(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><body><w:p w:rsidR="00B2223B" w:rsidRPr="00EE4ABE" w:rsidRDefault="00B2223B" w:rsidP="00B2223B"><w:pPr><w:pStyle w:val="Corpsdetexte"/><w:spacing w:after="120" w:line="262" w:lineRule="exact"/><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr></w:pPr><w:r w:rsidRPr="00EE4ABE"><w:rPr><w:rFonts w:asciiTheme="minorHAnsi" w:hAnsiTheme="minorHAnsi" w:cstheme="minorHAnsi"/><w:w w:val="105"/></w:rPr><w:t xml:space="preserve">Description: Barrels</w:t></w:r></w:p></body>`)
            })
